These notes are for the EDITORS of uberon
...
Make sure you have an ID range in the [idranges file](uberon-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [uberon-edit.owl](uberon-edit.owl)

** DO NOT EDIT uberon.obo OR uberon.owl in the top level directory **

[../../uberon.owl](../../uberon.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/obophenotype/uberon) for details.
 ...
 * [uberon-idranges.owl](uberon-idranges.owl)
...
This generates derived files such as uberon.owl and uberon.obo and places
 ...
 * https://github.com/obophenotype/uberon/releases/new
...
what is in the `owl:versionIRI` of the derived uberon.owl (`data-version` in
uberon.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/uberon.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/uberon/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/obophenotype/uberon.svg?branch=master)](https://travis-ci.org/obophenotype/uberon)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/obophenotype](https://travis-ci.org/profile/obophenotype)
 2. click the "Sync account" button
 3. Click the tick symbol next to uberon
