 ...
 * *Definition* = The cranial most segment of the sternum. Located ventrally with a quadrangular shape, wider superiorly and narrower inferiorly, it articulates with the clavicles and the first two ribs[MP,WP]. [ [database_cross_reference](../../ef/oboInOwl#hasDbXref.md) = MP:0012668, [database_cross_reference](../../ef/oboInOwl#hasDbXref.md) = Wikipedia:Manubrium ]
