 ...
 * *[definition](../../IAO/15/IAO_0000115.md)* = Anatomical cluster consisting of only a bony element or a combination of a bony element and one or more scales, or only modified scales, which lies in a fin fold at the base of the uppermost ray.
 ...
 * *[rdf-schema#label](../../el/rdf-schema#label.md)* = pelvic axillary process
