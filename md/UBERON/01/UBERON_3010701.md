...
## Class : m. latissimus dorsi

 * *IRI* = http://purl.obolibrary.org/obo/UBERON_3010701
 * *Label* = m. latissimus dorsi
 * *Definition* = Muscle which originates from the ventral surface of the dorsal fascia and inserts on the deltoid crest of the humerus. [ [database_cross_reference](../../ef/oboInOwl#hasDbXref.md) = AAO:MEJ ]
 ...
 * *[definition](../../IAO/15/IAO_0000115.md)* = Muscle which originates from the ventral surface of the dorsal fascia and inserts on the deltoid crest of the humerus.
 ...
 * *[rdf-schema#label](../../el/rdf-schema#label.md)* = m. latissimus dorsi
