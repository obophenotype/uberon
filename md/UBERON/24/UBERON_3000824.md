...
## Class : tenuitas cristaeformis

 * *IRI* = http://purl.obolibrary.org/obo/UBERON_3000824
 * *Label* = tenuitas cristaeformis
 * *Definition* = Leading (anterior) portion of the scapula, which is thinner than the rest of the shaft. [ [database_cross_reference](../../ef/oboInOwl#hasDbXref.md) = AAO:LAP ]
 ...
 * *[definition](../../IAO/15/IAO_0000115.md)* = Leading (anterior) portion of the scapula, which is thinner than the rest of the shaft.
 ...
 * *[rdf-schema#label](../../el/rdf-schema#label.md)* = tenuitas cristaeformis
