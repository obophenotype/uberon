...
## Class : M. coracoradialis

 * *IRI* = http://purl.obolibrary.org/obo/UBERON_3010725
 * *Label* = M. coracoradialis
 * *Definition* = Muscle which originates from the omosternum and epicoracoid cartilage and inserts on the proximal radioulna. [ [database_cross_reference](../../ef/oboInOwl#hasDbXref.md) = AAO:MEJ ]
 ...
 * *[definition](../../IAO/15/IAO_0000115.md)* = Muscle which originates from the omosternum and epicoracoid cartilage and inserts on the proximal radioulna.
 ...
 * *[rdf-schema#label](../../el/rdf-schema#label.md)* = M. coracoradialis
